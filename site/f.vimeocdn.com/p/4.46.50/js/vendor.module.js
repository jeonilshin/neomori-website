/* VimeoPlayer - v4.46.50 - 2026-05-14 - https://player.vimeo.com/NOTICE.txt */
...
const eD = e => (t, r, n) => {
    ...
    tD = (e, t) => (r, n, o) => Object.assign({}, e, t(r, n, o));
...
function sD(e, t, r, n, o, i) {
    ...
    for (i.set(e, t), i.set(t, e); ++l < u;) {
        ...
        if (h) {
            if (!aD(t, function(e, t) {
                    if (!uD(h, t) && (p === e || o(p, e, r, n, i))) return h.push(t)
                })) {
                d = !1;
                break
            }
...
iD.prototype.add = iD.prototype.push = function(e) {
    return this.__data__.set(e, "__lodash_hash_undefined__"), this
}, iD.prototype.has = function(e) {
    return this.__data__.has(e)
};
var lD = CT ? CT.prototype : void 0,
    dD = lD ? lD.valueOf : void 0,
...
function bD(e, t, r, n, o) {
    return e === t || (null == e || null == t || !zT(e) && !zT(t) ? e != e && t != t : function(e, t, r, n, o, i) {
        ...
        if (d && !f) return i || (i = new $S), a || EA(e) ? sD(e, t, r, n, o, i) : function(e, t, r, n, o, i, a) {
            switch (r) {
                case "[object DataView]":
                ...
                case "[object Set]":
                    var s = 1 & n;
                    if (u || (u = fD), e.size != t.size && !s) return !1;
                    var c = a.get(e);
                    if (c) return c == t;
                    n |= 2, a.set(e, t);
                    var f = sD(u(e), u(t), n, o, i, a);
                    return a.delete(e), f;
                case "[object Symbol]":
        ...
        if (!(1 & r)) {
            var h = f && gD.call(e, "__wrapped__"),
                p = l && gD.call(t, "__wrapped__");
            if (h || p) {
                var v = h ? e.value() : e,
                    y = p ? t.value() : t;
        ...
        return !!d && (i || (i = new $S), function(e, t, r, n, o, i) {
            ...
            for (var c = s; c--;) {
                var f = u[c];
                if (!(a ? f in t : hD.call(t, f))) return !1
            }
            var l = i.get(e),
                d = i.get(t);
...
function _D(e, t) {
    if (e && "undefined" != typeof document) {
        ...
        if (o) {
            var a = wD.indexOf(i); - 1 === a && (a = wD.push(i) - 1, ED[a] = {}), r = ED[a] && ED[a][n] ? ED[a][n] : ED[a][n] = u()
        } else r = u();
...
const TD = e => "object" == typeof e && null !== e,
    SD = Symbol("skip"),
    AD = e => TD(e) && !(e instanceof RegExp) && !(e instanceof Error) && !(e instanceof Date),
    ID = (e, t, r, n = new WeakMap) => {
        if (r = {
                deep: !1,
                target: {},
                ...r
        ...
        delete r.target;
        const i = e => e.map(e => AD(e) ? ID(e, t, r, n) : e);
        ...
        for (const [a, u] of Object.entries(e)) {
            ...
            "__proto__" !== c && (r.deep && l && AD(f) && (f = Array.isArray(f) ? i(f) : ID(f, t, r, n)), o[c] = f)
        }
        return o
    };
var OD = (e, t, r) => {
    if (!TD(e)) throw new TypeError(`Expected an object, got \`${e}\` (${typeof e})`);
    return ID(e, t, r)
};
OD.mapObjectSkip = SD;
var RD = function() {
...
var PD = [/([a-z0-9])([A-Z])/g, /([A-Z])([A-Z][a-z])/g],
    MD = /[^A-Z0-9]+/gi;
            ...
            return void 0 === t && (t = {}),
                function(e, t) {
                    return void 0 === t && (t = {}),
                        function(e, t) {
                            void 0 === t && (t = {});
                            for (var r = t.splitRegexp, n = void 0 === r ? PD : r, o = t.stripRegexp, i = void 0 === o ? MD : o, a = t.transform, u = void 0 === a ? ND : a, s = t.delimiter, c = void 0 === s ? " " : s, f = DD(DD(e, n, "$1\0$2"), i, "\0"), l = 0, d = f.length;
                                "\0" === f.charAt(l);) l++;
                            for (;
                                "\0" === f.charAt(d - 1);) d--;
...
var kD = function(e, t) {
    return t = Object.assign({
        ...
        return [jD(t.exclude, e) ? e : CD(e, t.parsingOptions), r, XD(e, r, t)]
    }, t)
};
...
const UD = (e, t) => t.some(t => e instanceof t);
let BD, FD;
...
function GD(e) {
    return "function" == typeof e ? function(e) {
        return (FD || (FD = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(e) ? function(...t) {
            return e.apply(qD(this), t), KD(this.request)
        } : function(...t) {
            return KD(e.apply(qD(this), t))
        }
        ...
        VD.set(e, t)
    }(e), UD(e, BD || (BD = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(e, WD) : e)
}
...
function KD(e) {
    ...
    const t = GD(e);
    return t !== e && (zD.set(e, t), HD.set(t, e)), t
}
const qD = e => HD.get(e);
...
function $D(e, t, {
    ...
    return n && a.addEventListener("upgradeneeded", e => {
        n(KD(a.result), e.oldVersion, e.newVersion, KD(a.transaction), e)
...
const QD = ["get", "getKey", "getAll", "getAllKeys", "count"],
    JD = ["put", "add", "delete", "clear"],
    ZD = new Map;

function ex(e, t) {
    if (!(e instanceof IDBDatabase) || t in e || "string" != typeof t) return;
    if (ZD.get(t)) return ZD.get(t);
...
YD(e => ({ ...e,
    get: (t, r, n) => ex(t, r) || e.get(t, r, n),
    has: (t, r) => !!ex(t, r) || e.has(t, r)
}));
const tx = ["continue", "continuePrimaryKey", "advance"],
    ...
    ix = {
        get(e, t) {
            if (!tx.includes(t)) return e[t];
            let r = rx[t];
            return r || (r = rx[t] = function(...e) {
                nx.set(this, ox.get(this)[t](...e))
            }), r
        }
    };
async function* ax(...e) {
    ...
    const r = new Proxy(t, ix);
    for (ox.set(r, t), HD.set(r, qD(t)); t;) yield r, t = await (nx.get(r) || t.continue()), nx.delete(r)
}

function ux(e, t) {
    return t === Symbol.asyncIterator && UD(e, [IDBIndex, IDBObjectStore, IDBCursor]) || "iterate" === t && UD(e, [IDBIndex, IDBObjectStore])
}
YD(e => ({ ...e,
    get: (t, r, n) => ux(t, r) ? ax : e.get(t, r, n),
    has: (t, r) => ux(t, r) || e.has(t, r)
}));
var sx = t(function(e, t) {
...
function cx() {
    return cx = Object.assign || function(e) {
        for (var t = 1; t < arguments.length; t++) {
            var r = arguments[t];
            for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (e[n] = r[n])
        }
...
var fx, lx = ["bottom", "height", "left", "right", "top", "width"],
    dx = new Map,
    hx = function e() {
        var t = [];
        dx.forEach(function(e, r) {
            var n = r.getBoundingClientRect();
            (function(e, t) {
                return void 0 === e && (e = {}), void 0 === t && (t = {}), lx.some(function(r) {
                    return e[r] !== t[r]
                })
        ...
        }), fx = window.requestAnimationFrame(e)
    },
    px = "undefined" != typeof window ? $M.useLayoutEffect : $M.useEffect;
        ...
        if (n) {
            var e = function(e, t) {
                return {
                    observe: function() {
                        var r = 0 === dx.size;
                        dx.has(e) ? dx.get(e).callbacks.push(t) : dx.set(e, {
                            rect: void 0,
                            hasRectChanged: !1,
                            callbacks: [t]
                        }), r && hx()
                    ...
                    unobserve: function() {
                        ...
                        if (r) {
                            ...
                            n >= 0 && r.callbacks.splice(n, 1), r.callbacks.length || dx.delete(e), dx.size || cancelAnimationFrame(fx)
                        }
                    }
                }
            }(n, function(e) {
...
function Ex(e) {
    ...
    var z = function(e) {
            for (var t = e.measurements, r = e.outerSize, n = e.scrollOffset, o = t.length - 1, i = _x(0, o, function(e) {
                    return t[e].start
...
export {
    cR as $, lT as A, MI as B, u_ as C, lO as D, o_ as E, hO as F, eO as G, dT as H, i_ as I, pO as J, e_ as K, vO as L, a_ as M, hT as N, RS as O, yO as P, bO as Q, NT as R, _O as S, pT as T, vT as U, sT as V, PO as W, RO as X, NO as Y, eR as Z, TO as _, __ as a, p_ as a0, gS as a1, KT as a2, vR as a3, MR as a4, KI as a5, iT as a6, aT as a7, y_ as a8, xR as a9, LP as aA, mP as aB, xP as aC, CM as aD, _D as aE, Z_ as aF, MP as aG, kD as aH, $D as aI, YS as aJ, qS as aK, GS as aL, K_ as aM, m_ as aN, PT as aO, sx as aP, Ex as aQ, yN as aa, CN as ab, AT as ac, tP as ad, KN as ae, nP as af, rD as ag, eD as ah, tD as ai, ZM as aj, oD as ak, JM as al, KP as am, YP as an, $P as ao, JP as ap, tM as aq, qP as ar, QP as as, mD as at, w_ as au, bM as av, SM as aw, cP as ax, lP as ay, ZP as az, J_ as b, T_ as c, l_ as d, ZE as e, b_ as f, oT as g, nT as h, f_ as i, I_ as j, rT as k, d_ as l, v_ as m, tT as n, t_ as o, eT as p, r_ as q, ET as r, G_ as s, E_ as t, cT as u, s_ as v, uT as w, g_ as x, c_ as y, h_ as z
};