    ...
    const be = [function({
        ...
        const y = (e, t, s) => {
            ...
            I = () => {
                ...
                if (o = M(o), d = M(d), o && o.forEach(e => y(e, 0, t.nextSlideMessage)), d && d.forEach(e => y(e, 0, t.prevSlideMessage)), b()) {
        ...
        s("init", () => {
            ...
            initSlides: t => {
                ...
                r = Math.floor(o / n), a = Math.floor(o / n) === o / n ? o : Math.ceil(o / n) * n, "auto" !== s && "row" === l && (a = Math.max(a, Math.floor(s) * n)), i = a / n
            },
            unsetSlides: () => {
